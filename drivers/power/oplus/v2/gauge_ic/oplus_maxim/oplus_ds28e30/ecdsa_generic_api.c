 ...
 */
#define pr_fmt(fmt) "[GENERIC_API]([%s][%d]): " fmt, __func__, __LINE__
...
int ecc_convert_jacobian_to_affine(u32 *x, u32 *y, u32 *xq, u32 *yq, u32 *zq, struct ucl_type_curve *curve_params)
{
