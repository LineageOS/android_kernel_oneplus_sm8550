 ...
 */
#define pr_fmt(fmt) "[SHA256_STONE]([%s][%d]): " fmt, __func__, __LINE__
...
static const u32 k[64] = { 0x428a2f98, 0x71374491, 0xb5c0fbcf, 0xe9b5dba5, 0x3956c25b, 0x59f111f1, 0x923f82a4,
