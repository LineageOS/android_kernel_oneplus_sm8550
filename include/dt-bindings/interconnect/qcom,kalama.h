...
#define CAMSX_CAMNOC_CPHY_RX_CLK_SRC		(0)
#define CAMSX_CAMNOC_CSID_CSIPHY_RX_CLK		(1)
#define CAMSX_CAMNOC_CSIPHY0_CLK		(2)
#define CAMSX_CAMNOC_CSIPHY1_CLK		(3)
#define CAMSX_CAMNOC_CSIPHY2_CLK		(4)
#define CAMSX_CAMNOC_CSIPHY3_CLK		(5)
#define CAMSX_CAMNOC_CSIPHY4_CLK		(6)
#define CAMSX_CAMNOC_CSIPHY5_CLK		(7)
#define CAMSX_CAMNOC_CSIPHY6_CLK		(8)
#define CAMSX_CAMNOC_CSIPHY7_CLK		(9)
#define CAMSX_CAMNOC_IFE_LITE_CPHY_RX_CLK	(10)

#define CAMSX_CAMNOC_SLOW_AHB_CLK_SRC		(11)
#define CAMSX_CAMNOC_BPS_AHB_CLK		(12)
#define CAMSX_CAMNOC_CORE_AHB_CLK		(13)
#define CAMSX_CAMNOC_CPAS_AHB_CLK		(14)
#define CAMSX_CAMNOC_CRE_AHB_CLK		(15)
#define CAMSX_CAMNOC_DRV_AHB_CLK		(16)
#define CAMSX_CAMNOC_ICP_AHB_CLK		(17)
#define CAMSX_CAMNOC_IFE_LITE_AHB_CLK		(18)
#define CAMSX_CAMNOC_IPE_NPS_AHB_CLK		(19)

#define CAMSX_CAMNOC_FAST_AHB_CLK_SRC		(20)
#define CAMSX_CAMNOC_BPS_FAST_AHB_CLK		(21)
#define CAMSX_CAMNOC_CPAS_FAST_AHB_CLK		(22)
#define CAMSX_CAMNOC_IFE0_FAST_AHB_CLK		(23)
#define CAMSX_CAMNOC_IFE1_FAST_AHB_CLK		(24)
#define CAMSX_CAMNOC_IFE2_FAST_AHB_CLK		(25)
#define CAMSX_CAMNOC_IPE_NPS_FAST_AHB_CLK	(26)
#define CAMSX_CAMNOC_IPE_PPS_FAST_AHB_CLK	(27)
#define CAMSX_CAMNOC_SBI_FAST_AHB_CLK		(28)
#define CAMSX_CAMNOC_SFE0_FAST_AHB_CLK		(29)
#define CAMSX_CAMNOC_SFE1_FAST_AHB_CLK		(30)

#define CAMSX_CAMNOC_AXI_CLK_SRC		(31)
#define CAMSX_CAMNOC_AXI_CLK			(32)

#define CAMSX_CAMNOC_IFE_LITE_CLK_SRC		(33)
#define CAMSX_CAMNOC_CPAS_IFE_LITE_CLK		(34)
#define CAMSX_CAMNOC_IFE_LITE_CLK		(35)

#define CAMSX_CAMNOC_IFE_LITE_CSID_CLK_SRC	(36)
#define CAMSX_CAMNOC_IFE_LITE_CSID_CLK		(37)
